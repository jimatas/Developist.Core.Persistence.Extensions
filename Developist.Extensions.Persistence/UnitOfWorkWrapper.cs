...
{
    /// <summary>
    /// Implements the wrapper or decorator design pattern by wrapping an <see cref="IUnitOfWork"/> instance, which the default method implementations will delegate to.
